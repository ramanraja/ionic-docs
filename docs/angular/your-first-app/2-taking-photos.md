...
Next, open up `tab2.page.ts` and edit the class `Tab2Page`. First import the PhotoService class and add a method that calls the `addNewToGallery` method on the service:
