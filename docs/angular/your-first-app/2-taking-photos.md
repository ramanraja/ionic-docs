...
Next, open up `tab2.page.ts` and edit the class `Tab2Page`. First comment out the default constructor. Then import the PhotoService class and add a method that calls the `addNewToGallery` method on the service:
